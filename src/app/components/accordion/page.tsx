...
export default function AccordionPage() {
  return (
    <main className="p-8 sm:p-16">
      <Link href="/" className="text-sm text-blue-500 font-sans hover:underline">&larr; Back to home</Link>
      <h1 className="text-4xl font-bold mt-4 mb-12 font-sans">Accordion Component</h1>
      ...
      <Accordion type="single" collapsible className="w-full max-w-2xl mx-auto ">
        {accordionData.map(({ id, title, content }) => (
          ...
          >
            <AccordionTrigger className="text-lg font-bold font-sans cursor-pointer">{title}</AccordionTrigger>
            {content && (
